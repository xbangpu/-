...
int token = 0;
String LINE_TOKEN [3]   = {"DsoQBYLOSIm90FOvCmjkGMCvRO453ldl0NHVSD4JDcs","dLlAAVPAdw3tdSl1CmkbUBPD4pD6s9kR9520Q4XFTCT","bF5IvbwLk7zSaChj5XFbIGlgtDRb5PSBSapgwQVrykg"}; 
...
String message8 = "https://bc-410.000webhostapp.com/Untitled-1.html";
void setup() {
  Serial.begin(115200);
...
void loop() {
  ...
  if (currentMillis - previousMillis >=  100000) SendSticker();
